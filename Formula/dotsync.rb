class Dotsync < Formula
  ...
  url "https://files.pythonhosted.org/packages/e9/44/0ff444b1dd3f1df3c4948ac71911f10065643e45acbe5e6585707926164d/dotsync_fast-0.2.0.tar.gz"
  ...
  resource "hcgatewood_coda" do
    url "https://files.pythonhosted.org/packages/a1/98/1a2cf9299ae973436109d2a7f1e780ed33d0ac566d6e64b85991e00d03b5/hcgatewood_coda-1.0.0.tar.gz"
  ...
  def install
    venv = virtualenv_create(libexec, "python@3.12", system_site_packages: true)
    venv.pip_install resources
    venv.pip_install_and_link buildpath
  end

  test do
    assert_match "Usage: dotsync", shell_output("#{bin}/dotsync --help")
  end
end
